...
| [`stories/generics.md`](stories/generics.md) | [`spec/generics.md`](spec/generics.md) — the parameter model, the `<>`/`()` split, size-in-the-type, the deferred features, and why a language without pointers needed a second, dynamically sized container primitive |
