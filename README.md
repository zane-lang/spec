...
| Document | Purpose |
|---|---|
| [`spec/control-flow.md`](spec/control-flow.md) | Block arguments, the two control-flow intrinsics, the `core` branching and repetition built on them, `guard`, and 1-based ordinal rules |
