...
`ref` is legal in return types, local-variable declarations, fields, and nested storage types such as `Array[size]<ref Node>`. It is not legal in function parameter positions.
